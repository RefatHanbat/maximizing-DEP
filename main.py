...
if (x_axis_name == "P_S_dBm_cand"):
    ...
    x_axis_cand = np.arange(start=0.03,stop=0.30, step=0.03)
...
# myf_plot_Solutions_P_D(sys_param,x_axis_variables,Solutions_P_D, x_axis_variables_label)
